                                                ...
                                                public static char[][] loadMap(String path, World world) throws MapInvalidException {
                                                    ...
                                                    for (String eLine : entities) {
                                                        ...
                                                        if ("VEHICLE".equals(type)) {
                                                            if (parts.length < 7) throw new MapInvalidException("ERRO: VEHICLE deve ter ID, X, Y, SPEED, COLOR e SPECIAL.");
                                                            ...
                                                            world.addVehicle(new Vehicle(id, gx * Config.TILE_SIZE, gy * Config.TILE_SIZE, speed, dir, color, special));
