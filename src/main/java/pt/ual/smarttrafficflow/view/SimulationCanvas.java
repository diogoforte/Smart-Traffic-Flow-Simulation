...
// Responsável por renderizar graficamente o estado da simulação
public class SimulationCanvas extends Canvas {
    ...
    // Desenha o mapa, semáforos e veículos
    public void draw(char[][] map) {
        ...
        for (int r = 0; r < rows; r++) {
            for (int c = 0; c < cols; c++) {
                ...
                // Desenha relva como base para todas as células
        ...
        // Desenha os veículos com rotação baseada na direção
        for (Vehicle v : world.getVehicles()) {
            ...
            // Desenha sirenes se for um veículo especial
